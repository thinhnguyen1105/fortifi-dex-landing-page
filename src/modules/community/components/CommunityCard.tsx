...
const CommunityCard = (props: IProps) => (
  <div className="flex flex-col justify-between items-center py-16">
    ...
    <div className="flex flex-col items-center mt-10">
      ...
      <div className="font-sans hover:bg-slate-500 inline-block mt-4 rounded-full cursor-pointer text-center font-medium text-white bg-slate-800 text-sm py-2 px-6">
        {props.buttonText}
      </div>
    </div>
  </div>
